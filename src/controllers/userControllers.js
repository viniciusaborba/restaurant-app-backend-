...
class UserController {
    ...
    async create(req, res) {
        ...
        const validationPasswordLength = password.length <= 8 || password.length > 30

        if (validationPasswordLength) {
            throw new AppError("Senha deve ter no mínimo 8 caracteres e, no máximo, 30 caracteres", 401)
        }
